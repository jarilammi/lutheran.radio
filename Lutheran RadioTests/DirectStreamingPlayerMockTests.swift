//
//  DirectStreamingPlayerMockTests.swift
//  Lutheran RadioTests
//
//  Created by Jari Lammi on 31.5.2025.
//
//  Isolated mock-unit coverage for stream selection, security-validation doubles,
//  server selection, callbacks, and error-reset policy. No real AVPlayer attach.
//
//  Real-engine attach discard, soft silence, early-window recovery, and production
//  type surface checks live in ``DirectStreamingPlayerEngineTests``.
//
//  - SeeAlso: ``DirectStreamingPlayer``, ``StreamErrorType``,
...
@MainActor
final class DirectStreamingPlayerMockTests: XCTestCase {
