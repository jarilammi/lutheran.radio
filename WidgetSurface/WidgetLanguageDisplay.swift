...
/// `Localizable` keys for en/de/fi/sv/et (translated in all 48 UI languages), then
/// `code.capitalized`.
///
/// - Parameters:
...
///   48-language README Localizations table. Do not treat this helper as a 48-stream list.
