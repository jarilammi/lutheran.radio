...
/// `Localizable` keys for en/de/fi/sv/et (translated in all 50 UI languages), then
/// `code.capitalized`.
///
/// - Parameters:
...
///   50-language README Localizations table. Do not treat this helper as a 50-stream list.
