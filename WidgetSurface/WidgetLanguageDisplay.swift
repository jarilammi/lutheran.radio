...
/// `Localizable` keys for en/de/fi/sv/et (translated in all 45 UI languages), then
/// `code.capitalized`.
///
/// - Parameters:
...
///   45-language README Localizations table. Do not treat this helper as a 45-stream list.
