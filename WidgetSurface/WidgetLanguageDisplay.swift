...
/// `Localizable` keys for en/de/fi/sv/et (translated in all 40 UI languages), then
/// `code.capitalized`.
///
/// - Parameters:
...
///   40-language README Localizations table. Do not treat this helper as a 40-stream list.
