...
final class PlayerViewModel {
    ...
    var sleepTimerAccessibilityValue: String? {
        ...
        // preserving localized pluralization/positioning across all 22 languages.
        return unsafe String(
...
extension PlayerViewModel {
    ...
    /// - All 22 languages and all visual states are valid; the mock does not enforce stream count.
    ///
    /// - Parameters:
