...
final class PlayerViewModel {
    ...
    var sleepTimerAccessibilityValue: String? {
        ...
        // preserving localized pluralization/positioning across all 25 languages.
        return unsafe String(
...
extension PlayerViewModel {
    ...
    /// - All 25 languages and all visual states are valid; the mock does not enforce stream count.
    ///
    /// - Parameters:
