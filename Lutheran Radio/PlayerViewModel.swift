...
final class PlayerViewModel {
    ...
    var sleepTimerAccessibilityValue: String? {
        ...
        // preserving localized pluralization/positioning across all 24 languages.
        return unsafe String(
...
extension PlayerViewModel {
    ...
    /// - All 24 languages and all visual states are valid; the mock does not enforce stream count.
    ///
    /// - Parameters:
