...
/// in the dialog) to keep the localization entry live across all 24 languages.
///
...
///   SwiftUI wrapper (all 24 languages).
...
/// `decrease_volume`, `volume_set_to`). All 24 language translations remain in
