...
/// in the dialog) to keep the localization entry live across all 23 languages.
///
...
///   SwiftUI wrapper (all 23 languages).
...
/// `decrease_volume`, `volume_set_to`). All 23 language translations remain in
