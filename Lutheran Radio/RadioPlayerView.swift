...
/// in the dialog) to keep the localization entry live across all 26 languages.
///
...
///   SwiftUI wrapper (all 26 languages).
...
/// `decrease_volume`, `volume_set_to`). All 26 language translations remain in
