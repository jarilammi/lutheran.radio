...
/// in the dialog) to keep the localization entry live across all 27 languages.
///
...
///   SwiftUI wrapper (all 27 languages).
...
/// `decrease_volume`, `volume_set_to`). All 27 language translations remain in
