...
/// in the dialog) to keep the localization entry live across all 50 languages.
///
...
///   SwiftUI wrapper (all 50 languages).
...
/// `decrease_volume`, `volume_set_to`). All 50 language translations remain in
