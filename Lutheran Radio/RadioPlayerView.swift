...
/// in the dialog) to keep the localization entry live across all 40 languages.
///
...
///   SwiftUI wrapper (all 40 languages).
...
/// `decrease_volume`, `volume_set_to`). All 40 language translations remain in
