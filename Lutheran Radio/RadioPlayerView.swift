...
/// in the dialog) to keep the localization entry live across all 37 languages.
///
...
///   SwiftUI wrapper (all 37 languages).
...
/// `decrease_volume`, `volume_set_to`). All 37 language translations remain in
