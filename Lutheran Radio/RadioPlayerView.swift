...
/// in the dialog) to keep the localization entry live across all 32 languages.
///
...
///   SwiftUI wrapper (all 32 languages).
...
/// `decrease_volume`, `volume_set_to`). All 32 language translations remain in
