...
/// in the dialog) to keep the localization entry live across all 34 languages.
///
...
///   SwiftUI wrapper (all 34 languages).
...
/// `decrease_volume`, `volume_set_to`). All 34 language translations remain in
