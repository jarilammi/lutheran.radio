...
/// in the dialog) to keep the localization entry live across all 48 languages.
///
...
///   SwiftUI wrapper (all 48 languages).
...
/// `decrease_volume`, `volume_set_to`). All 48 language translations remain in
