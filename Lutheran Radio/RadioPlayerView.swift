...
/// in the dialog) to keep the localization entry live across all 45 languages.
///
...
///   SwiftUI wrapper (all 45 languages).
...
/// `decrease_volume`, `volume_set_to`). All 45 language translations remain in
