...
/// in the dialog) to keep the localization entry live across all 25 languages.
///
...
///   SwiftUI wrapper (all 25 languages).
...
/// `decrease_volume`, `volume_set_to`). All 25 language translations remain in
