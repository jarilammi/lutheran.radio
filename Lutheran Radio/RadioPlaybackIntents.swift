...
struct RadioLanguageQuery: EntityQuery {
    ...
    /// UI localization is the 45-language README Localizations table and is separate.
    ///
...
///
/// English source phrases below are the extraction keys. Spoken forms for all 45
