...
**Lutheran Radio** is a security-first iOS streaming application that delivers Lutheran radio streams to users in **23 languages** (da, de, el, en, es, et, fi, fit, fo, gag, is, kl, lt, lv, nb, nl, nn, pl, ru, se, sk, sq, sv).
...
3. **Localization**
   ...
   - All 23 languages must remain supported (see the language table in README.md for the authoritative list).
...
Protect the security model. Ship clean builds. Support all 23 languages.
