...
**Lutheran Radio** is a security-first iOS streaming application that delivers Lutheran radio streams to users in **29 languages** (bg, cs, da, de, el, en, es, et, fi, fit, fo, gag, hr, hu, is, kl, lt, lv, nb, nl, nn, pl, ro, ru, se, sk, sl, sq, sv).
...
3. **Localization**
   ...
   - All 29 languages must remain supported (see the language table in README.md for the authoritative list).
...
Protect the security model. Ship clean builds. Support all 29 languages.
