...
**Lutheran Radio** is a security-first iOS streaming application that delivers Lutheran radio streams to users in **32 languages** (bg, cs, da, de, el, en, es, et, fi, fit, fo, fr, gag, hr, hu, is, it, kl, lt, lv, nb, nl, nn, pl, pt, ro, ru, se, sk, sl, sq, sv).
...
Protect the security model. Ship clean builds. Support all 32 languages.
