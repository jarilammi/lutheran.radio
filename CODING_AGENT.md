...
**Lutheran Radio** is a security-first iOS streaming application that delivers Lutheran radio streams to users in **19 languages** (da, de, en, et, fi, fit, fo, gag, is, kl, lt, lv, nb, nn, pl, ru, se, sk, sv).
...
Protect the security model. Ship clean builds. Support all 19 languages.
