...
| Force-quit / missed terminate | Next cold launch ``observeExistingActivities()`` | Reap residuals (never re-adopt as live) | No half-dead `.playing` chrome without a live engine |
