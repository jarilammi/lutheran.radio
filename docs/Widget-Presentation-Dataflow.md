...
- `RadioPlayerCoordinator+StreamSwitch.swift` — paused/blocked switch tails re-sample SSOT via ``paintBlockedSwitchChromeFromSSOTIfIntentStillNotActive()`` (do not overwrite Connecting after a later play).
